          ...
          <div class="mypost">
            <ul>
              <li class="mywrite">
                ...
                <a href="<c:url value='/mypostcollection' />">내가 쓴 게시글</a>
                </li>
              <li class="mylike">
                <img class="mimg" src="${path}/resources/images/img/free-icon-heart-6063477%202.png" alt="좋아요">
                <a href="<c:url value='/likecollection' />">좋아요 누른 게시글</a>  
              </li>
              <li class="mycomment">
